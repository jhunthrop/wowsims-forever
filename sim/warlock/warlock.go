...
func NewWarlock(character *core.Character, options *proto.Player, warlockOptions *proto.WarlockOptions) *Warlock {
	...
	warlock.AddStatDependency(stats.Agility, stats.Crit, core.CritPerAgiAtLevel[warlock.Class]*core.CritRatingPerCritChance)
	...
	warlock.AddStatDependency(stats.Intellect, stats.Crit, core.CritPerIntAtLevel[warlock.Class]*core.CritRatingPerCritChance)
